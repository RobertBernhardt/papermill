...
export function getAllExamples() {
    return [
        // These are the examples that will be loaded when clicking "View More Examples"
        {
            ...
            contentFilePath: 'src/content/examples/pizza-economics.md',
            isInitial: false
        },
        {
            ...
            contentFilePath: 'src/content/examples/emoji-hieroglyphics.md',
            isInitial: false
        },
        {
            id: 'pillow-forts',
            ...
            contentFilePath: 'src/content/examples/pillow-forts.md',
            isInitial: false
        },
        {
            id: 'meme-evolution',
            ...
            contentFilePath: 'src/content/examples/meme-evolution.md',
            isInitial: false
        },
        {
            ...
            contentFilePath: 'src/content/examples/playground-governance.md',
            isInitial: false
        },
        {
            ...
            contentFilePath: 'src/content/examples/recursive-procrastination.md',
            isInitial: false
        }
    ];
}
...
/**
 * Load markdown content for an example
 * @param {string} filePath - The path to the markdown file
 * @returns {Promise<string>} Promise resolving to the markdown content
 */
export async function loadExampleContent(filePath) {
    try {
